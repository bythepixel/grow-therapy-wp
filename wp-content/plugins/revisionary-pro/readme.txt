...
= 3.7.0 - 19 Jun 2025 =
* Feature : Archive setting to control maximum revisions limit
...
* Fixed : Loco Translate - loco.xml had wrong file paths

= 3.6.8 - 5 May 2025 =
* Fixed : Submit Revision button in Revision editor skipped Planner Notification

= 3.6.7 - 1 May 2025 =
* Fixed : Classic Editor - Submit Revision button caption was missing for Revisors
...
* Compat : PublishPress Planner - Creation of default Notification rules was skipped if Revisions Pro active 
* Fixed : Async Planner Notifications did not display Revision status or links
* Fixed : Planner Notifications did not display link for Revision Queue, Revision Preview
* Fixed : Planner Notifications Edit Revision linked to published post instead of Revision
* Fixed : Planner Notifications were not sent for changes applied by Revision Queue bulk edit or row action link
* Fixed : Planner Notification for Revision Scheduled was not sent under some configurations / server conditions
* Fixed : Edit Notification screen help sidebar did not include Revision short tags
* Change : Disable "Revision Status Change" Notification by default if Statuses Pro is inactive, to avoid redundancy with "Revision Submitted" etc.
* Change : Statuses Pro - Clarify an Edit Revision Status caption
...
= 3.6.5 - 24 Mar 2025 =
* Compat : PublishPress Planner - default Notifications for Post creation / update were triggered by Revision creation / update
* Compat : PublishPress Planner - support Notification validation safeguards in Planner 4.7.2

= 3.6.4 - 18 Mar 2025 =
* Compat : PublishPress Planner - Creation of default Notification rules was skipped if Revisions Pro active 
* Compat : PublishPress Planner - Restore default Notification rules skipped due to Revisions Pro activation

= 3.6.3 - 14 Mar 2025 =
* Compat : WooCommerce - Revising WooCommerce Product Variation caused other variations to be lost
* Compat : WooCommerce - Approving revision to a WooCommerce Variation causes original variation to be replaced
* Compat : Elementor - Save Draft caused Revision to be converted to non-revision
* Compat : Elementor - Publish button hidden after Revision update
* Compat : Divi - Preview of home page revision retrieved wrong post content
* Compat : Planner - Support Revision Author as a Notification Receiver
...
* Compat : PublishPress Permissions Pro / Capabilities Pro: Permissions compat mode not applied if Planner plugin inactive
* Compat : PublishPress Permissions Pro / Capabilities Pro: cannot set type-specific capabilities for Revision status if Planner plugin is active
* Compat : W3 Total Cache: Clean cache after revision publication
* Compat : ACF Better Search: SQL error on Posts screen
...
* Fixed : Revision Archive - Scheduled Revisions did not show actual submission time
...
* Fixed : Revisions Settings - Translations were not applied for some captions
* Compat : Elementor - Error on page CSS generation when previewing archived revision
* Compat : Elementor - Revision creation redirected to Posts screen if post type is not enabled for Elementor editing
...
* Compat : Elementor - Top bar Publish button was not recaptioned for revision submission / update
* Compat : Elementor - Published page CSS corrupted under some conditions
...
* Compat : ACF - Custom fields configured for use only with front page were not available in revisions of that page
* Compat : Divi - Fatal error on new revision creation, under some configurations with Divi 4.25.1
* Compat : Elementor - Revision submission by a non-Editor failed on some sites
* Compat : Elementor - If "Limit to one revision per post" setting is enabled, revision submission by Elementor redirects to a blank screen
...
= 3.5.8.2 - 25 Apr 2024 =
* Compat : WooCommerce - Revision approval caused Variation IDs of Variable Products to be reset
* Compat : Divi - Fatal error on new revision creation, under some configurations
...
* Compat : Elementor - Revision publication cleared custom CSS under some configurations
* Compat : Elementor - Revision previews did not load custom Elementor CSS under some conditions
* Compat : Elementor - Saving a draft of revision with front end editor causes revision submission UI to be hidden from Gutenberg editor
* Compat : Elementor - Revision preview redirect was applied prior to update operation under some conditions
* Compat : Elementor - New plugin setting to disable preview redirect if necessary
...
* Compat : Elementor - Could not use Elementor to edit revisions of front page
* Compat : Elementor + LearnDash - Invalid redirect after creating new revision from front end
* Compat : LearnDash - Some custom fields were not copied to new revision
...
= 3.5.5 - 12 Dec 2023 =
* Feature : Option to make approval of revisions to Draft Posts also publish the post
* Compat : Advanced Custom Fields - Previews failed due of invalid filtering of revision ID by ACF
* Compat : Advanced Custom Fields - Previews of unsaved revision changes did not load correctly on some sites
...
* Fixed : Deactivation of Pro plugin left Revisions listed on Posts / Pages screen
...
* Compat : Elementor - Preview styling could be incorrect due to Elementor post css file enqueued at the wrong priority

= 3.5.3 - 30 Aug 2023 =
* Feature : Option to enable deletion of revisions in Revision Archive 
* Compat : Beaver Builder - Revision preview top bar was not displayed after front end revision edit
...
= 3.5.1 - 11 Aug 2023 =
* Fixed : Fatal Error on activation if plugin settings have never been saved
...
* Compat : Beaver Builder - Revision submission from front end left page as unsubmitted
* Compat : WPML - Performance issue on Posts / Pages screen
...
* Fixed : PHP Notice on Revisions > Settings > License
* Lang : Separate .pot file for Pro-specific strings
...
* Compat : Elementor - Revision publication broke page styling under some configurations
* Compat : Beaver Builder 2.7 - Redirect loop when new iframe editing mode is used
* Compat : Divi - Don't display revision preview buttons when displaying inside a Divi iFrame (use Divi's Submit button instead)
...
* Fixed : Elementor - Revisions were auto-created for new pages that use template library pages

= 3.1.11 - 9 Feb 2023 =
* Feature : Elementor - When editing / submitting a revision in Elementor, also submit revisions for embedded template library pages as they are edited. Further editing updates the same submitted revision.
* Compat : Elementor - While editing a revision with Elementor, revision top bar displayed inactive buttons
* Compat : Elementor - Rank Math SEO's Link Counter module interfered with revision submission in Elementor
* Compat : Elementor - Error in browser console when editing a revision in Elementor (empty is not defined)
...
= 3.1.10 - 22 Dec 2022 =
* Compat : Divi - Could not use WP Admin bar to enable visual builder for pages not previously edited by Divi
* Compat : Elementor - Revisions submitted by Elementor did not trigger a revision notification email
* Compat : Elementor - Preview of submitted revision failed to load CSS on some sites
...
* Compat : Advanced Custom Fields - Field groups for a specific page were not included on revisions of that page
* Lang : Separate .pot and .po files for Pro strings
...
= 3.0.11 - 23 Feb 2022 =
* Compat : Yoast SEO + Elementor - revision editing by Administrator or Editor updates published post
* Compat : Elementor: Revisors updating a revision saw an "Approved" message
* Compat : "Page Links To" plugin
* Change : Plugin API - minor additions, changes
