...
Content Blocks:
- content('<p>Some info or message here.</p>')
...
Lifecycle:
- handle() - processes the form submission
- render() - outputs the form

Output Demo
-----------

AltForms generates forms that match the WordPress admin UI, including form-table layout, notice boxes, and styled buttons.

Integration Tips
----------------

- Works inside tabbed admin pages:
...
- You can run multiple forms on one page by using unique slugs.
- You can also capture the output using output buffering if needed.
